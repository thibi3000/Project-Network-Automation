            ...
            try:
                ...
                with open(self.serverdatabase, "r") as serverdatabase:
                    ...
                    if valid == True:
                        ...
                        self.netmikoandwmidict["username"] = input(
                            "Please enter your username: ")
                        self.netmikoandwmidict["password"] = input(
        ...
        try:
            ...
            if self.netmikoandwmidict["os"] == "windows":
                ...
                if sys.platform == "win32":
                    ...
                    c = wmi.WMI(
                        self.netmikoandwmidict["host"], user=self.netmikoandwmidict["username"], password=self.netmikoandwmidict["password"],)
                    ...
                    for disk in c.Win32_logicaldisk():
                        ...
                        if disk.Caption == "C:":
                            ...
                            usedspace = float(disk.Size) - \
                                float(disk.FreeSpace)

                            print(
                                f"{round(usedspace / 1024**3,2)} GB / {round(float(disk.Size) / 1024**3, 2)} GB")
                    ...
                    for memory in c.Win32_OperatingSystem():
                        ...
                        usedmemory = float(
                            memory.TotalVisibleMemorySize) - float(memory.FreePhysicalMemory)

                        print(
                            f"{round(usedmemory / 1024**2,2)} GB / {round(float(memory.TotalVisibleMemorySize) / 1024**2, 2)} GB")
                    ...
                    for cpu in c.Win32_Processor():
                        ...
                        if cpu.LoadPercentage == None:
                            ...
                            raise Exception(
                                "Error: Unable to retrieve CPU LoadPercentage!")
                    ...
                    raise Exception(
                        "Error: Sorry! Monitoring Windows machines is not possible on Linux & macOS!")
